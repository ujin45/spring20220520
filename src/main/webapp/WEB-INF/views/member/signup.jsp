	...
	$(document).ready(function(){
		...
		$("#checkIdButton1").click(function(e){
			...
			$.ajax({
				...
				success : function(data){ // data from server
					switch (data){
					case "ok" :
				...
				error : function(){
					$("#idMessage1").text("중복확인 중 문제 발생, 다시 시도해 주세요");
				},
				complete : function(){
		...
		$("#checkEmailButton1").click(function(e){
			...
			$.ajax({
				...
				error : function(){
					$("#emailMessage1").text("중복확인 중 문제 발생, 다시 시도해 주세요");
				},
				complete : function(){
		...
		$("#checkNickNameButton1").click(function(e){
			...
			$.ajax({
				...
				error : function(){
					$("#nickNameMessage1").text("중복확인 중 문제 발생, 다시 시도해 주세요");
				},
				complete : function(){
		...
		$("#passwordInput1, #passwordInput2").keyup(function(){
			...
			pwOk = false;
			if (pw1 === pw2) {
				$("#passwordMessage1").text("패스워드가 일치합니니다.");
				pwOk = true;
			}else {
